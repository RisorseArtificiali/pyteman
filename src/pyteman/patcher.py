...
class Patcher:
    def __init__(self, rules, log):
        ...
        # it twice left the plan holding rules that said they were not there: a
        # generator produced a full plan and an empty tuple. That is the
    ...
    @property
    def rules(self):
        """The ruleset as a tuple, derived from the plan.

        Read-only so the ruleset has one representation (_plan), not two.
        A post-construction rebind (`p.rules = [...]`) raises AttributeError.
        """
